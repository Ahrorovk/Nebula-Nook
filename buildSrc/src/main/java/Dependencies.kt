...
object MapDependencies {
    ...
    const val mapForgeMapAndroid =
        "org.mapsforge:mapsforge-map-android:${Versions.map.mapForgeMapAndroid}"
...
object RetrofitDependencies {
    ...
    const val moshi = "com.squareup.retrofit2:converter-moshi:${Versions.network.retrofit.moshi}"
}

object HiltDependencies {
    const val navigation =
        "androidx.hilt:hilt-navigation-compose:${Versions.android.hilt.navigation}"
    const val android = "com.google.dagger:hilt-android:${Versions.android.hilt.android}"
    const val androidCompiler =
        "com.google.dagger:hilt-android-compiler:${Versions.android.hilt.androidCompiler}"
...
object ComposeDependencies {
    ...
    const val material = "androidx.compose.material3:material3:${Versions.compose.material3}"
